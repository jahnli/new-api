  ...
  }[] = [
    {
      ...
      tooltip: (
        <TokenBreakdownTooltipContent
          ...
          inputTokens={stat.uncached_input_tokens ?? 0}
          outputTokens={stat.uncached_output_tokens ?? 0}
          cacheReadTokens={stat.cache_read_tokens ?? 0}
          cacheWriteTokens={stat.cache_write_tokens ?? 0}
        />
      ),
