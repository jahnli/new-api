...
export function userConsumptionColumn<T extends UserColumnRow>(
  ...
  return {
    ...
    cell: ({ row }) => {
      ...
      const unitPrice =
        hasCost && hasTokens
          ? calculateUnitPricePer100MTokens(cost, tokens)
          : 0;
      ...
      return (
        <Tooltip>
          ...
          >
            <div className="flex min-w-0 items-baseline justify-between gap-x-0.5">
            ...
            <div className="text-muted-foreground/70 flex min-w-0 items-baseline justify-between gap-x-0.5 !text-[13px] tabular-nums">
