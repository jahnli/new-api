...
export const PROMPT_PRESETS: PromptPreset[] = [
  {
    category: 'AI 智能制造',
    prompts: [
      'AI 智能制造软件解决方案高端主视觉，未来工业指挥中心连接半导体晶圆厂、光伏工厂、电池产线和流程化工工厂，发光数据流贯穿全场，蓝白企业科技风，照片级真实感，超高清细节',
      ...
      'AI 工业智能体主视觉，多个智能体分别负责排程优化、质量预测、设备诊断、能耗分析和异常处置，围绕数字工厂中枢协同运转，蓝白色高端 SaaS 产品视觉',
