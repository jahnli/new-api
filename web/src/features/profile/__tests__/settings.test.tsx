...
describe('user settings saves across profile and security', () => {
  ...
  it('lets the user disable demo mode without overwriting other settings', async () => {
    ...
    const demoMode = screen.getByRole('switch', { name: 'Demo Mode' })
    expect(demoMode).toBeChecked()
    fireEvent.click(demoMode)
