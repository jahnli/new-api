...
type TaskUsagePricingEditorProps = {
  ...
  /** Legacy flat currency input (#049). Prefer `currency`. */
...
function resolveLegacyCurrency(
  props: Pick<
  ...
  const symbol = props.currencySymbol?.trim() || USD_PRICING_CURRENCY.symbol
  return { label: symbol, symbol, exchangeRate: rate }
}

const TaskUsagePricingEditorImpl = memo(function TaskUsagePricingEditor(
