...
const createModelSchema = (t: Translate) =>
  z.object({
    ...
    ModelPricingInputInLocalCurrency: z.boolean(),
...
const createGroupSchema = (t: Translate) =>
  z.object({
    ...
    GroupVendorRatio: createJsonStringField(t),
...
export function RatioSettingsCard({
  ...
  const modelNormalizedDefaults = useRef({
    ...
    ModelPricingInputInLocalCurrency:
      modelDefaults.ModelPricingInputInLocalCurrency,
  ...
  const groupNormalizedDefaults = useRef({
    ...
    GroupVendorRatio: normalizeJsonString(groupDefaults.GroupVendorRatio),
  ...
  const groupForm = useForm<GroupFormValues>({
    ...
    defaultValues: {
      ...
      GroupVendorRatio: formatJsonForTextarea(groupDefaults.GroupVendorRatio),
  ...
  const saveModelRatios = useCallback(
    async (values: ModelFormValues) => {
      const normalized = {
        ...
        ModelPricingInputInLocalCurrency:
          values.ModelPricingInputInLocalCurrency,
  ...
  const saveGroupRatios = useCallback(
    async (values: GroupFormValues) => {
      const normalized = {
        ...
        GroupVendorRatio: normalizeJsonString(values.GroupVendorRatio),
      ...
      return (
        <>
          ...
          <ModelRatioForm
            ...
            inputInLocalCurrency={modelForm.watch(
              'ModelPricingInputInLocalCurrency'
            )}
            onInputInLocalCurrencyChange={(value) => {
              modelForm.setValue('ModelPricingInputInLocalCurrency', value)
              updateOption.mutate({
