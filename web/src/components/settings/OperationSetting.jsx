...
import SettingsSecurityAudit from '../../pages/Setting/Operation/SettingsSecurityAudit';
  ...
  return (
    <>
      <Spin spinning={loading} size='large'>
        ...
        {/* 安全审计设置 */}
        <Card style={{ marginTop: '10px' }}>
          <SettingsSecurityAudit options={inputs} refresh={onRefresh} />
        </Card>
      </Spin>
    </>
  );
