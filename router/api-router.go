...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		logRoute.GET("/export", middleware.DisableCache(), middleware.AdminAuth(), controller.ExportLogs)
		logRoute.GET("/self/export", middleware.DisableCache(), middleware.UserAuth(), controller.ExportSelfLogs)
