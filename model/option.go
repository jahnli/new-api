...
func InitOptionMap() {
	...
	common.OptionMap["RecordRequestMessageEnabled"] = strconv.FormatBool(common.RecordRequestMessageEnabled)
	...
	common.OptionMap["GroupVendorRatio"] = ratio_setting.GroupVendorRatio2JSONString()
	...
	common.OptionMap["ExternalModeEnabled"] = strconv.FormatBool(operation_setting.ExternalModeEnabled)
	...
	common.OptionMap["ModelPricingInputInLocalCurrency"] = strconv.FormatBool(false)
...
func updateOptionMap(key string, value string) (err error) {
	...
	if strings.HasSuffix(key, "Enabled") || key == "DefaultCollapseSidebar" || key == "DefaultUseAutoGroup" || key == "SMTPForceAuthLogin" || key == "SMTPInsecureSkipVerify" {
		...
		case "RecordRequestMessageEnabled":
			common.RecordRequestMessageEnabled = boolValue
		...
		case "ExternalModeEnabled":
			operation_setting.ExternalModeEnabled = boolValue
		...
		case "ModelPricingInputInLocalCurrency":
			// boolean value already stored in OptionMap, no additional global state needed
		}
	}
	...
	case "GroupVendorRatio":
		err = ratio_setting.UpdateGroupVendorRatioByJSONString(value)
