...
func GenerateTextOtherInfo(ctx *gin.Context, relayInfo *relaycommon.RelayInfo, modelRatio, groupRatio, completionRatio float64,
	...
	if relayInfo.PriceData.GroupRatioInfo.HasVendorRatio {
		other.SetPublic("vendor_group_ratio", relayInfo.PriceData.GroupRatioInfo.GroupRatio)
		other.SetPublic("vendor_id", relayInfo.PriceData.GroupRatioInfo.VendorID)
	}
	...
	if relayInfo.ClientApp != "" {
		other.SetPublic("user_agent", relayInfo.ClientApp)
	}
...
func GenerateMjOtherInfo(relayInfo *relaycommon.RelayInfo, priceData hosttypes.PriceData) *model.LogOther {
	...
	if priceData.GroupRatioInfo.HasVendorRatio {
		other.SetPublic("vendor_group_ratio", priceData.GroupRatioInfo.GroupRatio)
		other.SetPublic("vendor_id", priceData.GroupRatioInfo.VendorID)
	}
