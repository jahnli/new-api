...
func (summary *textQuotaSummary) hasBillableUsage() bool {
	return summary.FixedPriceBilling || summary.TotalTokens > 0 || !summary.ToolCallSurchargeQuota.IsZero()
}
...
func PostTextConsumeQuota(ctx *gin.Context, relayInfo *relaycommon.RelayInfo, usage *dto.Usage, extraContent []string) {
	...
	if imageGenerationDetails, ok := common.GetContextKey(ctx, constant.ContextKeyImageGenerationDetails); ok {
		other.SetPublic("image_generation_details", imageGenerationDetails)
	}
