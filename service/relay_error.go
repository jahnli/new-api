...
func DecideRelayRetry(c *gin.Context, err *types.AIGatewayError, retryTimes int) PolicyDecision {
	if err == nil {
...
func ShouldRetryRelayError(c *gin.Context, openaiErr *types.AIGatewayError, retryTimes int) bool {
